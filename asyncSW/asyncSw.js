...
let trilogiesDiv = document.getElementById("trilogiesDiv");
let sortedByDate = document.getElementById("sortedByDate");
let sortedByOrder = document.getElementById("sortedByOrder");
let originalTrilogyDiv = document.getElementById("originalTrilogyDiv");
let prequelTrilogyDiv = document.getElementById("prequelTrilogyDiv");
...
let populateOriginalTrilogy = (movieData) => {
    ...
    filterOriginal.forEach((el)=> {populateTableBody(tables[2], el.title, el.director, el.producer, el.release_date)});    
};
...
let populatePrequelTrilogy = (movieData) => {
    ...
    filterPrequel.forEach((el)=> {populateTableBody(tables[3], el.title, el.director, el.producer, el.release_date)});    
};
...
let populateSequelTrilogy = (movieData) => {
    ...
    filterSequel.forEach((el)=> {populateTableBody(tables[4], el.title, el.director, el.producer, el.release_date)});    
};
